...
def concordance(listSentences, word):
    ...
    ifficult to understand a lecture in a foreign language . The students have taken no notice of these 
     'll find it your advantage to know a foreign language .
    ...
    , eu fico . Ela está costurando um vestido . O idioma Na'vi é usado em Avatar . Vamos continuar com  It is almost impossible to learn a foreign 
    """
